...
func main() {
	...
	toFlagBoolVar("kafka.allow-auto-topic-creation", "If true, the broker may auto-create topics that we requested which do not already exist, default is true.", true, "true", &opts.allowAutoTopicCreation)
