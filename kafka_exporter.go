...
func main() {
	...
	kingpin.Flag("sasl.username", "SASL user name.").Envar("SASL_USERNAME").StringVar(&opts.saslUsername)
	kingpin.Flag("sasl.password", "SASL user password.").Envar("SASL_PASSWORD").StringVar(&opts.saslPassword)
